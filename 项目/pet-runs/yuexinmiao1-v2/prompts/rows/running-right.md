Create one horizontal animation strip for Codex pet `yuexinmiao1`, state `running-right`.
...
Identity: same pet in every frame: Preserve the exact cheerful cartoon kitten identity, face, palette, proportions, outlines, and sticker-pack aesthetic from the supplied v1 spritesheet.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
