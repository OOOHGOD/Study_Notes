Create Codex v2 pet look row 9 for `yuexinmiao1` as exactly 8 full-body frames in this order: 000, 022.5, 045, 067.5, 090, 112.5, 135, 157.5.
...
REPAIR REQUIREMENT: The previous row had a progressive scale collapse from 000 to 157.5. Keep every one of the eight complete cats at the same exact apparent body height, head size, outline thickness, and grounded foot baseline. Turning toward down-right must change only gaze/head/upper-body orientation; it must not make the cat smaller, farther away, crouched lower, or compressed. Use the approved 000 and 090 cardinal sizes as the constant scale target for all eight slots.
